# Apache VFS with Jinbe

This guide covers using Jinbe with [Apache Commons VFS](https://commons.apache.org/vfs/), which supports local filesystems and various remote filesystem backends.
...
```ocaml
libraryDependencies += "io.github.cchantep" %% "jinbe-vfs" % "{{site.latest_release}}"
```
...
import io.github.cchantep.jinbe.vfs.{ VFSStorage, VFSTransport }
...
import io.github.cchantep.jinbe.vfs._
