...
This guide helps you get started with Jinbe in your project.

*See also: [API Documentation](https://cchantep.github.io/jinbe/api/)*

## Choosing your backend

Jinbe supports multiple object storage backends. Select the module that matches your storage provider:
...
libraryDependencies += "io.github.cchantep" %% "jinbe-google" % jinbeVer

// For VFS (filesystem)
libraryDependencies += "io.github.cchantep" %% "jinbe-vfs" % jinbeVer
...
import io.github.cchantep.jinbe.Bucket
import io.github.cchantep.jinbe.s3.WSS3
import io.github.cchantep.jinbe.google.GoogleStorage
...
```scala
import io.github.cchantep.jinbe.{ BucketRef, ObjectStorage }
...
import io.github.cchantep.jinbe.{ BucketRef, Object }
import io.github.cchantep.jinbe.s3.WSS3BucketRef
...
```scala
import io.github.cchantep.jinbe.{ BucketRef, ObjectRef }
