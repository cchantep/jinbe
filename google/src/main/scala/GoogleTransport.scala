...
import io.github.cchantep.jinbe.{ Compat, URIProvider }
import io.github.cchantep.jinbe.exception.JinbeUnknownError

import Compat.javaConverters._

/**
 * Jinbe transport for Google Cloud Storage
...
object GoogleTransport {
  ...
  import io.github.cchantep.jinbe.LongVal
