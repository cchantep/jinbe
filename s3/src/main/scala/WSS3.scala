...
object S3 {
   ...
   *   io.github.cchantep.jinbe.s3.S3(
   ...
   * {{{
   * def init(implicit wc: play.api.libs.ws.ahc.StandaloneAhcWSClient) =
   *   io.github.cchantep.jinbe.s3.S3.virtualHost(
   *     accessKeyId = "accessKey",
   *     secretAccessKeyId = "secretAccessKey",
   *     scheme = "https",
   *     host = "s3.amazonaws.com")
   ...
   * {{{
   * def init(implicit wc: play.api.libs.ws.ahc.StandaloneAhcWSClient) =
   *   io.github.cchantep.jinbe.s3.S3.virtualHostAwsV4(
   *     accessKeyId = "accessKey",
   *     secretAccessKeyId = "secretAccessKey",
   *     scheme = "https",
   *     host = "s3.amazonaws.com",
   ...
   * import io.github.cchantep.jinbe.s3.S3
   *
