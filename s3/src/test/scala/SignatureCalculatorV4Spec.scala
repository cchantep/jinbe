package io.github.cchantep.jinbe.s3 // as testing internals
  ...
  "Canonical request" should {
    ...
    val req1: play.shaded.ahc.org.asynchttpclient.Request = {
      ...
      def build() = new RequestBuilder()
        .setUrl(
          "http://my-bucket.s3.amazonaws.com/documents%20and%20settings/my-object//example"
        )
    ...
    "encode path" in {
      val encodedName = WSRequestBuilder
        .appendName(new StringBuilder(), "foo !#$%&'()*+,/:;=?@[] étoile")
        .result()

      val req = new RequestBuilder()
        .setUrl(s"http://my-bucket.s3.amazonaws.com/${encodedName}")
        .build()

      calculator.canonicalUri(
        req
      ) must_=== "/foo%20%21%23%24%26%26%27%28%29%2A%2B%2C/%3A%3B%3D%3F%40%5B%5D%20%C3%A9toile"
    }

    "compute canonical empty URI" in {
      val req2 = new RequestBuilder().setUrl("http://iam.amazonaws.com").build()
    ...
    "compute canonical headers" >> {
      "for request #1" in {
        calculator.canonicalHeaders(
          req1,
          "20150830T123600Z",
          "UNSIGNED-PAYLOAD"
        ) must_=== ("content-type:application/x-www-form-urlencoded; charset=utf-8\nhost:my-bucket.s3.amazonaws.com\nmy-header1:a b c\nmy-header2:\"a b c\"\nx-amz-content-sha256:UNSIGNED-PAYLOAD\nx-amz-date:20150830T123600Z\n" -> "content-type;host;my-header1;my-header2;x-amz-content-sha256;x-amz-date")
      }
      ...
      "with request style header" in {
        ...
        calculator.canonicalHeaders(
          ...
          "20180329T203920Z",
          "UNSIGNED-PAYLOAD"
        ) must_=== ("""content-type:text/plain; charset=UTF-8
host:my-bucket.s3.amazonaws.com
x-amz-content-sha256:UNSIGNED-PAYLOAD
...
""" -> "content-type;host;x-amz-content-sha256;x-amz-date;x-request-style")
  ...
  "String-to-sign" should {
    ...
    "compute credential scope" in {
      calculator.credentialScope("20150830T123600Z") must_=== credentialScope
    }
...
b243baaf68a974acdc3a4273f5cdab2f6118c28b0f54623242c108eb45309a35"""
  ...
  "Signature" should {
    ...
    "derive signing key" in {
      ...
      Hex.encodeHexString(
        calculator.deriveSigningKey("20150830T123600Z", mac)
      ) must_=== "c4afb1cc5771d871763a393e44b703571b55cc28424d1a5e86da6ed3c154a4b9"
    }
  ...
  "Authorization header" should {
    "be prepared" in {
      calculator.authorizationHeader(
        ...
        signatureX
      ) must_=== s"AWS4-HMAC-SHA256 Credential=AKIDEXAMPLE/${credentialScope}, SignedHeaders=content-type;host;x-amz-date, Signature=${signatureX}"
    }
  }
...
f536975d06c0309214f805bb90ccff089219ecd68b2577efef23edd43b7e1a59"""
  ...
  private val signatureX =
    "5d672d79c15b13162d9279b0855cfba6789a8edb4c82c400e06b5924a6f2b5d7" // corresponds to stringToSignX
