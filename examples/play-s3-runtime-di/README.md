...
This is a sample application to show how to integrate the Jinbe's library
in a play application. This app uses Guice to handle runtime dependency injection.

This example uses the following:

- Jinbe: an object storage library
- Play! Framework v2.7.0 as a web framework
- Jinbe play plugin
- Jinbe S3 plugin as the demo uses the S3 storage
...
- Use the environment variable "JINBE_URI"
...
import the [postman json file](jinbe_postman.json) 
to discover all the features described below.

## Features

This application covers the main features of the Jinbe's library 
